...
export interface MagicAuthContextProps {
   ...
   */
  loginWithMagicLink: (config: LoginWithMagicLinkConfiguration) => Promise<string | null>;
  logout: () => Promise<void>;
  isLoggedIn: boolean;
...
export const MagicAuthContext = React.createContext<MagicAuthContextProps>(undefined as any);
